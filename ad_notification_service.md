...
## Dòng dữ liệu và tích hợp dịch vụ

### Event từ Kafka (trạng thái mục tiêu)
...
## Sequence Diagram: Đăng ký hoặc cập nhật FCM token
...
## Sequence Diagram: Xem inbox và đánh dấu đã đọc
...
## Sequence Diagram: UC-13 - Nhận thông báo tự động
...
## Sequence Diagram: UC-14 - Gửi thông báo khuyến mãi
