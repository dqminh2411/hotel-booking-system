...
public interface AdminService {
    ...
    Page<TenantResponse> getListTenant(TenantStatus status, String search, Pageable pageable);

    TenantResponse createTenant(CreateTenantRequest request);

    TenantDetailResponse getTenantDetail(UUID tenantId);

    TenantDetailResponse updateTenant(UUID tenantId, UpdateTenantRequest request);
